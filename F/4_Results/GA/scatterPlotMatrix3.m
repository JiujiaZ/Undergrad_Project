    ...
    for j = 1:i
        ...
        if i == j
            ...
            text(0.5, 0.5, var_labels(j), 'Units', 'normalized',...
                'HorizontalAlignment', 'center', 'Color', 'black', 'FontSize', 30,'FontWeight', 'bold', 'Interpreter','Latex')
        else
...
c=colorbar;
c.Position=[hp_b(1)+0.22 hp_b(2)  0.01  hp_t(2)+hp_t(4)-hp_b(2)];
c.YTick=[0:0.25:1];
c.YTickLabel={'-1','-0.5','0','0.5','1'};
c.Label.String='R'
c.Label.FontSize=25
c.Label.Position=[2.9,0.65,0];
c.Label.Rotation=0;
c.FontSize=20;
colormap(cmap)
if need_save

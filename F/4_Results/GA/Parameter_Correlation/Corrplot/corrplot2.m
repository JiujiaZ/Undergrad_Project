function varargout = corrplot2(varargin)
...
%varNames = cellfun(@(s)s(1:12),varNames,'UniformOutput',false);
...
switch next
    ...
    case {'replace','replaceall'}
        ...
        for i = 1:numVars
            ...
            Xlabels(i) = xlabel(Ax(numVars,i),varNames{i},'interpreter','latex','Fontsize',16);
            Ylabels(i) = ylabel(Ax(i,1),varNames{i},'interpreter','latex','Fontsize',16);
